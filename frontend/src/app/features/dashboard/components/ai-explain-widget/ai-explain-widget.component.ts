...
@Component({
  ...
  template: `
    <app-ai-panel
      [title]="'dashboard.ai_widgets.explain_title' | translate"
      icon="bi-info-circle"
      [result]="result()"
      [loading]="loading()"
      [buttonLabel]="'dashboard.ai_widgets.explain_btn' | translate"
      [loadingLabel]="'dashboard.ai_widgets.explain_loading' | translate"
      (generate)="generate()"
    />
  `,
})
