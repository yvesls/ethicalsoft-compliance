...
import com.ethicalsoft.ethicalsoft_complience.adapters.out.postgres.model.dto.auth.GoogleAuthDTO;
...
public class GoogleAuthUseCase {
    ...
    public AuthDTO execute(GoogleAuthDTO googleAuthDTO) {
        return authCommandPort.googleAuth(googleAuthDTO);
    }
}
