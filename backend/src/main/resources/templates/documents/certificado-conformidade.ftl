...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .cert-header h1 { font-size: 26px; margin: 8px 0 2px; color: #1e7d34; letter-spacing: 0.04em; }
  ...
  .cert-footer { display: table; width: 100%; margin-top: 18px; }
...
<div class="frame-inner">
  ...
  <div style="margin: 14px 6% 6px; padding: 10px 14px; border: 1px solid #cbd2d9;
